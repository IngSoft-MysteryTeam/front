...
test("Al terminar la partida se muestran las estadisticas en un sumario", () => {
    ...
    expect(screen.getByRole(("heading"), {name:'Santi ha ganado la partida'})).toBeInTheDocument();
    ...
    expect(screen.getByRole(("heading"), {name:'Además, hizo 3 sospechas'})).toBeInTheDocument();
    expect(screen.getByRole(("heading"), {name:'David no acuso. hizo 4 sospechas'})).toBeInTheDocument();
    expect(screen.getByRole(("heading"), {name:'Se realizaron 7 sospechas en total'})).toBeInTheDocument();
    expect(screen.getByRole(("heading"), {name:'La partida duró 10:02:33'})).toBeInTheDocument();
